...
class UnixxClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pyUnixx.functions.FastTelethon import upload_file
        from pyUnixx.functions.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from pyUnixx.functions.FastTelethon import download_file
        from pyUnixx.functions.helper import progress
